...
const GROUPS: FooterLinkGroup[] = [
  ...
  },
  {
    heading: "Contact",
    links: [
      { label: "Phone", href: "tel:+34600663107", external: true },
      {
        label: "Email",
...
const SOCIALS = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=100086318628410",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/carspa_marbella_wraps_ppf/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@carspamarbella?_r=1&_t=ZN-92erZnDXCre",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
