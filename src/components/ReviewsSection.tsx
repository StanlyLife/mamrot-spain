...
const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    name: "Odin Bekken",
    rating: 5,
    text: "I recommend everyone to use CarSpa Marbella! Really skilled! I handed in my GLE for a thorough treatment/paint correction. The car is unrecognizable! It looks absolutely flawless now 💎 Excellent service and truly a magician when it comes to detailing. This is something you have to try 😊😊",
  ...
  },
  {
    ...
    name: "John Joh",
    rating: 5,
    text: "Professionalism from A to Z. Patrik is a skilled guy who puts his heart and soul into taking care of other people's cars! The result is excellent, and I can truly recommend CarSpa Marbella. 10/10 from me!",
